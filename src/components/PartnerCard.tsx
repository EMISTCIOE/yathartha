...
const PartnerCard : React.FC<IPartnerCard> = ({rank, name, image}) => {
  return (
    <div className=" bg-theme-green flex flex-col justify-evenly items-center m-4 max-w-[25rem] max-h-[20rem] relative hover:scale-[105%] transition-transform duration-300">
