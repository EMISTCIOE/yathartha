...
const NotFound : React.FC = () => {
  return (
    <section className="min-h-[100vh] flex flex-col justify-evenly pt-[10vh] items-center w-[100%] bg-theme-black-alt">
        <div>
            <h1 className="text-theme-red sm:text-4xl text-xl font-bold">Oops!</h1>
            <span className="text-theme xl:text-[22rem] sm:text-[12rem] text-9xl font-extrabold">404</span>
        </div>
        <h1 className="text-theme-red sm:text-4xl text-xl font-bold">Page Not Found</h1>
