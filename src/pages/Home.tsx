...
const Home : React.FC = () => {
    return (
        <main className="flex flex-col justify-evenly items-center min-h-[100vh] w-[100%]">
            <img src={HeroImage} className="absolute top-0 left-0 min-h-[100%] xl:h-[160%] brightness-75 -z-10 object-cover"/>
            <div className="flex flex-col justify-evenly md:items-start items-center md:w-[80%] w-[100%] mt-[10%]">
                <h1 className="lg:text-8xl text-7xl font-extrabold my-4 text-theme">{_EventDetails.name}</h1>
